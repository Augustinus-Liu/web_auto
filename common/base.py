...
class Base():
    ...
    def find(self,locator):
        ...
        if not isinstance(locator,tuple):
            raise LocatorTypeError("参数类型错误，locator必须是元祖类型，例如loc=('id','value')")
        else:
...
if __name__ == "__main__":
    ...
    loc_1 = ("id", "kw")
    loc_2 = ("id","su")
    loc_3 = ("xpath","//*[@id='2']/h3/a")
    web.send(loc_1, "hello")
    web.click(loc_2)
    web.click(loc_3)

    # \31  > h3 > a.OP_LOG_LINK.c-text.c-text-public.c-text-mult.c-gap-left-small
    ##\32  > h3 > a
    #// *[ @ id = '2'] / h3 / a
    #class ="OP_LOG_LINK c-text c-text-public c-text-mult c-gap-left-small"
    sleep(9)
    driver.close()